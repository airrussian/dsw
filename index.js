...
var devices = Array(10).fill({}).map(function (_, i) { return ({ type: 0x1, serial: 10 + i, password: 1 }); });
console.log(devices);
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var _loop_1, _i, devices_1, device;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(function () {
                                    ...
                                    var worker = new worker_threads_1.Worker("./deviceWorker.js", { workerData: device });
